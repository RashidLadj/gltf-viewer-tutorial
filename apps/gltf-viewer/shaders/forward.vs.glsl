...
void main()
{
  ...
  // On multiplie par la modelMatrix car on veut uniquement leur orientation
  // dans le "tangent space",
  // si on voulait aussi leur directino il faudrait multiplier en plus par la
  // normal matrix
